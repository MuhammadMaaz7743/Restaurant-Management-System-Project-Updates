...
{
    public class Deal_ModuleController : Controller
    {
        //
        // GET: /Deal_Module/
        ...
        {
            return View(new Deal_Module());
        }
        [HttpPost]
        public ActionResult InsertDeal_Module(Deal_Module c1)
        {
            Deal_Module c2 = new Deal_Module();
            if (ModelState.IsValid)
            {
                ...
                ViewBag.Message = msg;
                return RedirectToAction("GetAllDeal_Module_List", "Deal_Module");
            }
            return View();
        }
        [HttpGet]
        ...
        {
            return View(new Deal_Module().GetAllDeal_ModuleList());
        }

        [HttpGet]
        public ActionResult GetAllDeal_Module_ListBYIDs(int C_ID)
        {
            Deal_Module DL1 = new Deal_Module();
            Deal_Module DL2 = DL1.GetDeal_Module_ListByID(C_ID);
            return View(DL2);
        ...
        [HttpPost]
        public ActionResult UpdateAllDeal_Module_ListBYIDs(Deal_Module deal_list)
        {
        ...
        [HttpPost]
        public ActionResult DeleteAllDeal_Module_ListBYIDs(Deal_Module deal_list)
        {
            Deal_Module DL = new Deal_Module();
            if (ModelState.IsValid)
            {
