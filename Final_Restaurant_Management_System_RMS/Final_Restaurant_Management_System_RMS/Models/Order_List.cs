...
namespace Final_Restaurant_Management_System_RMS.Models
{
    public class Order_List
    {
        ...
        public void AddOrder_List(Order_List orderlist)
        {
        ...
        public List<Order_List> GetAllOrder_List()
        {
            List<Order_List> StaffList = new List<Order_List>();
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
        ...
        public Order_List GetOrder_ListByID(int ID)
        {
        ...
        public void UpdateOrder_List(Order_List list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
