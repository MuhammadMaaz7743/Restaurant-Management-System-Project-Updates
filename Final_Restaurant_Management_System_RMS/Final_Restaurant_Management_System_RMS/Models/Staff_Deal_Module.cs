...
{
    public class Staff_Deal_Module
    {
        ...
        public void AddDeal_Module(Staff_Deal_Module Staff)
        {
        ...
        public List<Staff_Deal_Module> GetAllDeal_ModuleList()
        {
            List<Staff_Deal_Module> Deal_ModuleList = new List<Staff_Deal_Module>();
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
            ...
            while (reader.Read())
            {
                Deal_ModuleList.Add(new Staff_Deal_Module
                {
        ...
        public Staff_Deal_Module GetDeal_Module_ListByID(int ID)
        {
        ...
        public void UpdateDeal_Module_List(Staff_Deal_Module list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
        ...
        public void DeleteDeal_Module_List(Staff_Deal_Module list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
