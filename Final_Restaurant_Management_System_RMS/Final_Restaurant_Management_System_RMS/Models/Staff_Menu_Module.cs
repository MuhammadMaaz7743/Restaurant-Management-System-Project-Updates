...
{
    public class Staff_Menu_Module
    {
        ...
        public void AddMenu_Module(Staff_Menu_Module Staff)
        {
        ...
        public List<Staff_Menu_Module> GetAllMenu_ModuleList()
        {
            List<Staff_Menu_Module> Menu_ModuleList = new List<Staff_Menu_Module>();
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
            ...
            while (reader.Read())
            {
                Menu_ModuleList.Add(new Staff_Menu_Module
                {
        ...
        public Staff_Menu_Module GetMenu_Module_ListByID(int ID)
        {
        ...
        public void UpdateMenu_Module_List(Staff_Menu_Module list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
        ...
        public void DeleteMenu_Module_List(Staff_Menu_Module list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
