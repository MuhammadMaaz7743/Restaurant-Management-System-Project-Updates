...
{
    public class Staff_Table_Reservation
    {
        ...
        public void AddTable_Reservation(Staff_Table_Reservation Reservation)
        {
        ...
        public List<Staff_Table_Reservation> GetAllTable_ReservationList()
        {
            List<Staff_Table_Reservation> Table_ReservationList = new List<Staff_Table_Reservation>();
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
            ...
            while (reader.Read())
            {
                Table_ReservationList.Add(new Staff_Table_Reservation
                {
        ...
        public Staff_Table_Reservation GetTable_Reservation_ListByID(int ID)
        {
        ...
        public void UpdateTable_Reservation_List(Staff_Table_Reservation list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
        ...
        public void DeleteTable_Reservation_List(Staff_Table_Reservation list)
        {
            string connection = ConfigurationManager.ConnectionStrings["connection"].ConnectionString;
            SqlConnection con = new SqlConnection(connection);
            con.Open();
